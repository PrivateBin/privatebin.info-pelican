...
The most notable change is the switch of the default template to `bootstrap5`. We also switch to the Jdenticons library by default for the comment creator icons, as it doesn't require the GD library.
